	...
	float YawOverride)
{
	...
	for (USceneComponent* Pt: ImmutablePts)
	{
		...
		const FVector AdjustmentLocation = FVector(Pt->GetComponentLocation().X, Pt->GetComponentLocation().Y, Pt->GetComponentLocation().Z + HitResult.ImpactPoint.Z);

		Pt->SetWorldLocation(AdjustmentLocation);
